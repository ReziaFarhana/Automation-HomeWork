...
public class AmazonHomePage extends HelperClass{
    ...
    public static void logIn() {
        ...
        HelperClass.driver.findElement(By.cssSelector("#ap_email")).sendKeys("");
        HelperClass.driver.findElement(By.xpath("//input[@tabindex='5']")).click();

    }

    @Test()
    public static void checkHello() {
        HelperClass.driver.findElement(By.id("glow-ingress-line1")).isDisplayed();
    }

    @Test()
    public static void checkPrime() {
        HelperClass.driver.findElement(By.xpath("//*[@id=\"nav-link-prime\"]/span[1]")).click();
    }

    @Test()
    public static void customerService() {
        driver.findElement(By.xpath("(//a[text()='Customer Service'])[1]")).click();
        HelperClass.driver.findElement(By.xpath("/html/body/div[2]/div[4]/div[1]/div/div[3]/div[2]/a/div/div/div/div[2]/h3")).click();
    }
    ...
    public static void amazonPharmacy() {
        ...
        driver.findElement(By.cssSelector("#ap_email")).sendKeys("farhana.eco@gmail.com");
